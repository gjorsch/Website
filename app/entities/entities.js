'use strict';
//Controller for entities excerpt of Agrovoc - GlUES linking
angular.module('LinkedDataBrowserApp.entities', ['ngRoute'])
...
.controller('entitiesCtrl', ["$scope", "$http",'$location', '$anchorScroll', function($scope, $http, $location, $anchorScroll) {
  $scope.language = {
